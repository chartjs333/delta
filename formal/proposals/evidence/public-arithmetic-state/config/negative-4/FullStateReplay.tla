...
ReplayValue33 == 1
ReplayValue34 == "vote"
ReplayValue35 == "validator"
ReplayValue36 == ((ReplayValue20 :> ReplayValue21) @@ (ReplayValue22 :> ReplayValue29) @@ (ReplayValue27 :> ReplayValue28) @@ (ReplayValue35 :> ReplayValue2))
ReplayValue37 == ((ReplayValue32 :> ReplayValue33) @@ (ReplayValue34 :> ReplayValue36))
ReplayValue38 == {ReplayValue37}
ReplayValue39 == {ReplayValue36}
ReplayStates == <<
...
logicalTime |-> ReplayValue9,
materializedArtifacts |-> ReplayValue0,
messageMultiplicity |-> ReplayValue38,
messages |-> ReplayValue39,
parameterQCs |-> ReplayValue0,
parameterResults |-> ReplayValue0,
parameterVotes |-> ReplayValue0,
partition |-> ReplayValue0,
