...
currentCheckpoint |-> witnessValue_parent1,
currentReplayReceipts |-> {},
durableSequence |-> ((witnessValue_v1 :> 1) @@ (witnessValue_v2 :> 0) @@ (witnessValue_v3 :> 0) @@ (witnessValue_v4 :> 0)),
durableVotes |-> {(("body" :> witnessValue_configA) @@ ("context" :> (("epoch" :> witnessValue_epoch1) @@ ("height" :> witnessValue_h1) @@ ("kind" :> "ROUND_CONFIG"))) @@ ("kind" :> "ROUND_CONFIG") @@ ("validator" :> witnessValue_v1))},
ecVotes |-> {},
eligibilityCertificates |-> {},
finalizedCertificates |-> {},
inputSetCertificates |-> {},
...
view |-> 0,
viewChangeQCs |-> {},
volatileVotes |-> {(("body" :> witnessValue_configA) @@ ("context" :> (("epoch" :> witnessValue_epoch1) @@ ("height" :> witnessValue_h1) @@ ("kind" :> "ROUND_CONFIG"))) @@ ("kind" :> "ROUND_CONFIG") @@ ("validator" :> witnessValue_v1))}],
[abortQCs |-> {},
abortReason |-> "NO_ABORT",
abortRequests |-> {},
abortVotes |-> {},
...
aggregateVotes |-> {},
aggregationPlanCertificates |-> {},
alive |-> {witnessValue_v2, witnessValue_v3, witnessValue_v4},
apcVotes |-> {},
applyCandidates |-> {},
applyQCs |-> {},
applyVotes |-> {},
...
publishedObjects |-> {},
receivedVotes |-> {},
recoveryState |-> ((witnessValue_v1 :> "CRASHED") @@ (witnessValue_v2 :> "READY") @@ (witnessValue_v3 :> "READY") @@ (witnessValue_v4 :> "READY")),
reduceApplyRejections |-> {},
rejectedCommitments |-> {},
rejectedPublications |-> {},
repairAttempts |-> ((witnessValue_content1 :> 0)),
