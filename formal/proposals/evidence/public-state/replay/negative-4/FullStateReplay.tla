...
logicalTime |-> 0,
materializedArtifacts |-> {},
messageMultiplicity |-> {(("copy" :> 1) @@ ("vote" :> (("body" :> witnessValue_configA) @@ ("context" :> (("epoch" :> witnessValue_epoch1) @@ ("height" :> witnessValue_h1) @@ ("kind" :> "ROUND_CONFIG"))) @@ ("kind" :> "ROUND_CONFIG") @@ ("validator" :> witnessValue_v1))))},
messages |-> {(("body" :> witnessValue_configA) @@ ("context" :> (("epoch" :> witnessValue_epoch1) @@ ("height" :> witnessValue_h1) @@ ("kind" :> "ROUND_CONFIG"))) @@ ("kind" :> "ROUND_CONFIG") @@ ("validator" :> witnessValue_v1))},
parameterQCs |-> {},
parameterResults |-> {},
parameterVotes |-> {},
partition |-> {},
...
WitnessSelected == CASE witnessIndex = 1 -> ProposeRoundConfigAction
 [] witnessIndex = 2 -> SendVoteEnvelopeAction
