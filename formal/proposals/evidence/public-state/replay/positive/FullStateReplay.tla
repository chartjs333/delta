...
publishedObjects |-> {},
receivedVotes |-> {},
recoveryState |-> ((witnessValue_v1 :> "RECOVERING") @@ (witnessValue_v2 :> "READY") @@ (witnessValue_v3 :> "READY") @@ (witnessValue_v4 :> "READY")),
reduceApplyRejections |-> {},
rejectedCommitments |-> {},
rejectedPublications |-> {},
repairAttempts |-> ((witnessValue_content1 :> 0)),
...
proposals |-> {(("body" :> witnessValue_configA) @@ ("context" :> (("epoch" :> witnessValue_epoch1) @@ ("height" :> witnessValue_h1) @@ ("kind" :> "ROUND_CONFIG"))))},
publishedObjects |-> {},
receivedVotes |-> {(("body" :> witnessValue_configA) @@ ("context" :> (("epoch" :> witnessValue_epoch1) @@ ("height" :> witnessValue_h1) @@ ("kind" :> "ROUND_CONFIG"))) @@ ("kind" :> "ROUND_CONFIG") @@ ("validator" :> witnessValue_v1))},
recoveryState |-> ((witnessValue_v1 :> "READY") @@ (witnessValue_v2 :> "READY") @@ (witnessValue_v3 :> "READY") @@ (witnessValue_v4 :> "READY")),
reduceApplyRejections |-> {},
rejectedCommitments |-> {},
rejectedPublications |-> {},
...
currentCheckpoint |-> witnessValue_parent1,
currentReplayReceipts |-> {},
durableSequence |-> ((witnessValue_v1 :> 1) @@ (witnessValue_v2 :> 1) @@ (witnessValue_v3 :> 0) @@ (witnessValue_v4 :> 0)),
durableVotes |-> {(("body" :> witnessValue_configA) @@ ("context" :> (("epoch" :> witnessValue_epoch1) @@ ("height" :> witnessValue_h1) @@ ("kind" :> "ROUND_CONFIG"))) @@ ("kind" :> "ROUND_CONFIG") @@ ("validator" :> witnessValue_v1)), (("body" :> witnessValue_configA) @@ ("context" :> (("epoch" :> witnessValue_epoch1) @@ ("height" :> witnessValue_h1) @@ ("kind" :> "ROUND_CONFIG"))) @@ ("kind" :> "ROUND_CONFIG") @@ ("validator" :> witnessValue_v2))},
ecVotes |-> {},
eligibilityCertificates |-> {},
finalizedCertificates |-> {},
inputSetCertificates |-> {},
...
view |-> 0,
viewChangeQCs |-> {},
volatileVotes |-> {(("body" :> witnessValue_configA) @@ ("context" :> (("epoch" :> witnessValue_epoch1) @@ ("height" :> witnessValue_h1) @@ ("kind" :> "ROUND_CONFIG"))) @@ ("kind" :> "ROUND_CONFIG") @@ ("validator" :> witnessValue_v1)), (("body" :> witnessValue_configA) @@ ("context" :> (("epoch" :> witnessValue_epoch1) @@ ("height" :> witnessValue_h1) @@ ("kind" :> "ROUND_CONFIG"))) @@ ("kind" :> "ROUND_CONFIG") @@ ("validator" :> witnessValue_v2))}],
[abortQCs |-> {},
abortReason |-> "NO_ABORT",
abortRequests |-> {},
abortVotes |-> {},
...
logicalTime |-> 0,
materializedArtifacts |-> {},
messageMultiplicity |-> {(("copy" :> 1) @@ ("vote" :> (("body" :> witnessValue_configA) @@ ("context" :> (("epoch" :> witnessValue_epoch1) @@ ("height" :> witnessValue_h1) @@ ("kind" :> "ROUND_CONFIG"))) @@ ("kind" :> "ROUND_CONFIG") @@ ("validator" :> witnessValue_v2))))},
messages |-> {(("body" :> witnessValue_configA) @@ ("context" :> (("epoch" :> witnessValue_epoch1) @@ ("height" :> witnessValue_h1) @@ ("kind" :> "ROUND_CONFIG"))) @@ ("kind" :> "ROUND_CONFIG") @@ ("validator" :> witnessValue_v2))},
parameterQCs |-> {},
parameterResults |-> {},
parameterVotes |-> {},
partition |-> {},
...
proposals |-> {(("body" :> witnessValue_configA) @@ ("context" :> (("epoch" :> witnessValue_epoch1) @@ ("height" :> witnessValue_h1) @@ ("kind" :> "ROUND_CONFIG"))))},
publishedObjects |-> {},
receivedVotes |-> {(("body" :> witnessValue_configA) @@ ("context" :> (("epoch" :> witnessValue_epoch1) @@ ("height" :> witnessValue_h1) @@ ("kind" :> "ROUND_CONFIG"))) @@ ("kind" :> "ROUND_CONFIG") @@ ("validator" :> witnessValue_v1)), (("body" :> witnessValue_configA) @@ ("context" :> (("epoch" :> witnessValue_epoch1) @@ ("height" :> witnessValue_h1) @@ ("kind" :> "ROUND_CONFIG"))) @@ ("kind" :> "ROUND_CONFIG") @@ ("validator" :> witnessValue_v2))},
recoveryState |-> ((witnessValue_v1 :> "READY") @@ (witnessValue_v2 :> "READY") @@ (witnessValue_v3 :> "READY") @@ (witnessValue_v4 :> "READY")),
reduceApplyRejections |-> {},
rejectedCommitments |-> {},
rejectedPublications |-> {},
...
currentCheckpoint |-> witnessValue_parent1,
currentReplayReceipts |-> {},
durableSequence |-> ((witnessValue_v1 :> 1) @@ (witnessValue_v2 :> 1) @@ (witnessValue_v3 :> 1) @@ (witnessValue_v4 :> 0)),
durableVotes |-> {(("body" :> witnessValue_configA) @@ ("context" :> (("epoch" :> witnessValue_epoch1) @@ ("height" :> witnessValue_h1) @@ ("kind" :> "ROUND_CONFIG"))) @@ ("kind" :> "ROUND_CONFIG") @@ ("validator" :> witnessValue_v1)), (("body" :> witnessValue_configA) @@ ("context" :> (("epoch" :> witnessValue_epoch1) @@ ("height" :> witnessValue_h1) @@ ("kind" :> "ROUND_CONFIG"))) @@ ("kind" :> "ROUND_CONFIG") @@ ("validator" :> witnessValue_v2)), (("body" :> witnessValue_configA) @@ ("context" :> (("epoch" :> witnessValue_epoch1) @@ ("height" :> witnessValue_h1) @@ ("kind" :> "ROUND_CONFIG"))) @@ ("kind" :> "ROUND_CONFIG") @@ ("validator" :> witnessValue_v3))},
ecVotes |-> {},
eligibilityCertificates |-> {},
finalizedCertificates |-> {},
inputSetCertificates |-> {},
...
logicalTime |-> 0,
materializedArtifacts |-> {},
messageMultiplicity |-> {(("copy" :> 1) @@ ("vote" :> (("body" :> witnessValue_configA) @@ ("context" :> (("epoch" :> witnessValue_epoch1) @@ ("height" :> witnessValue_h1) @@ ("kind" :> "ROUND_CONFIG"))) @@ ("kind" :> "ROUND_CONFIG") @@ ("validator" :> witnessValue_v3))))},
messages |-> {(("body" :> witnessValue_configA) @@ ("context" :> (("epoch" :> witnessValue_epoch1) @@ ("height" :> witnessValue_h1) @@ ("kind" :> "ROUND_CONFIG"))) @@ ("kind" :> "ROUND_CONFIG") @@ ("validator" :> witnessValue_v3))},
parameterQCs |-> {},
parameterResults |-> {},
parameterVotes |-> {},
partition |-> {},
...
ecVotes |-> {},
eligibilityCertificates |-> {},
finalizedCertificates |-> {(("body" :> witnessValue_configA) @@ ("context" :> (("epoch" :> witnessValue_epoch1) @@ ("height" :> witnessValue_h1) @@ ("kind" :> "ROUND_CONFIG"))) @@ ("signers" :> {witnessValue_v1, witnessValue_v2, witnessValue_v3}))},
inputSetCertificates |-> {},
iscVotes |-> {},
lateAvailabilityEvidence |-> {},
leaseActive |-> {},
