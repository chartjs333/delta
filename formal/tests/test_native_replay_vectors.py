"""Native replay examples must reject mutated source witnesses before emission."""
...
import generate_native_replay_vectors as generator  # noqa: E402
from native_durability_witness import EVENT_FIELDS, observation_id  # noqa: E402

n = generator.n


class NativeReplayVectorTests(unittest.TestCase):
    def setUp(self):
