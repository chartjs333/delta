...
**Reviewed**: 2026-08-23  
**Status**: Reconciled — implementation remains exact-preflight and hardware-gated
...
- [x] No QLoRA-specific certificate hierarchy or alternate current transition is permitted.
- [x] Absence of a physical 8 GiB runner produces `BLOCKED_HARDWARE`, never a synthetic `PASS`.
