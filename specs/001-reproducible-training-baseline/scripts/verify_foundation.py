...
FOUNDATION_COMPONENT_FILES = (
    ...
    "delta-protocol/schemas/baseline-config.schema.json",
    ...
    "delta-protocol/schemas/tokenizer.schema.json",
    "delta-protocol/schemas/training-state.schema.json",
    "delta-protocol/schemas/uv-lock-v1.json",
    ...
    "delta-worker-python/src/deltatorrent/cli/__init__.py",
