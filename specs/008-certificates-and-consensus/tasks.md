...
**Input**: `spec.md`, `plan.md`, Constitution 2.1.0, accepted Formal GO and merged feature 007
`2054f31ef0f6750645b924ef337a35d1737c619d`.

The authoritative certificate graph, robust arithmetic, vote lifecycle, aggregate coverage, apply
transition and current-pointer decision are native C++/C ABI. Java owns authenticated opaque
transport, opaque timers and bounded artifact effects only. Python owns worker-local ML only.
...
- T000–T005 are sequential and block canonical contracts and every production source.
- T006–T012 freeze all runtime-neutral bytes/IDs before C++ or Java consumes them.
- T013–T018 block seed descendants; T019–T025 block parameter committees.
- T026–T031 block aggregate/apply; T032–T039 block current publication.
- T040–T044 block refinement; T045–T053 close the phase without claiming feature 009.

## Exit Gate

All T000–T053 and HR008-001–HR008-019 pass; the complete certificate/apply chain is byte-identical
across four validators; every vote class is persist-before-send and restart safe; early randomness,
membership mutation, unsafe arithmetic, incomplete/mixed coverage, conflicting apply and uncertified
current fail closed; Java remains transport/timer/artifact-only; implementation traces refine the
accepted formal actions and final Constitution 2.1.0 compatibility evidence passes.
