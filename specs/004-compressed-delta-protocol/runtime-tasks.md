...
- [ ] **HR004-006** Add Python independent fixture generation from feature-002 normalized inputs.
- [ ] **HR004-007** Add Java FFM/direct/copy byte-preservation and malformed-envelope conformance tests.
- [ ] **HR004-008** Add GCC/Clang, x86_64/aarch64 where available, endian and signed-boundary golden vectors.
- [ ] **HR004-009** Add ASan/UBSan, parser libFuzzer and allocation-limit corpus.
