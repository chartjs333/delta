...
EXPECTED_TESTS: Final = {
    ...
    "delta_runtime.vote_fixture_export",
    "delta_runtime.trace_export",
    "delta_runtime.native_exit",
    "delta_runtime.record_vote_mutant_conflict",
    "delta_runtime.record_vote_mutant_context_guard",
    "delta_runtime.record_vote_mutant_arithmetic_admission",
    "delta_runtime.record_vote_mutant_durability",
    "delta_ffi.target",
    "delta_ffi.abi",
