...
const strings = {
  sharedProfileNote: ['One local profile for Admin UI and Presentation. Definitions are saved on this computer.', 'Общий локальный профиль Admin UI и Presentation. Настройки сохраняются на этом компьютере.'],
